...
WORKDIR /src
COPY ["EjemploRailwayNube/EjemploRailwayNube.csproj", "EjemploRailwayNube/"]
RUN dotnet restore "./EjemploRailwayNube/EjemploRailwayNube.csproj"
COPY . .
WORKDIR "/src/EjemploRailwayNube"
